...
workspace.addStep(function (workspace) {
    ...
    workspace.setNextStep('end-first-if');
});

workspace.addStep(function (workspace) {
    workspace.gotoLine(11);
    workspace.console.comment('fin du premier test');
...
workspace.addStep(function (workspace) {
    ...
    workspace.console.question('Est ce que $age < 18 (strictement inférieur à 18) ?');
    workspace.console.answer('$i vaut 15', 500);
    workspace.console.success('la condition est valide, on rentre  dans le bloc', 1000);
});
